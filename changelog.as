/*
this is only a .as so the changelog gets sent with the mod, .txt files don't get sent

----- Waffle Balance -----

Balance mod to try and make the game faster paced and more enjoyable.
Trying to add features/new mechanics to less used items
