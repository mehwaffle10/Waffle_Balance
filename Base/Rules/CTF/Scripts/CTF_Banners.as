...
{
    // Waffle: Adjust build phase banner
	u32 duration = buildBannerDuration * getTicksASecond();
	string text = "Prepare for Battle!";
	string secondary_text = "Increased build speed and resupplies";

	Icon@ left_icon = Icon("InteractionIcons.png", 21, Vec2f(32, 32), Vec2f(192, 32), 0);
	Icon@ right_icon = Icon("InteractionIcons.png", 21, Vec2f(32, 32), Vec2f(128, -32), 0);
