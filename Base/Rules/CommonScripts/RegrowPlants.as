...
const f32 flower_grow_chance = -1.0f;  // 0.0005f;  // Waffle: No food can grow
const f32 grain_grow_chance = -1.0f;  // flower_grow_chance + 0.0005f; //add flower chance to prevent them from overriding each other  // Waffle: No food can grow
const f32 chicken_grow_chance = -1.0f;  // 0.001f; // chickens are plants don't @ me   // Waffle: No chickens can grow
