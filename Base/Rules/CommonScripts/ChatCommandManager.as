...
class ChatCommandManager
{
	...
	{
        // Waffle: Allow ! instead of /
		if (text.substr(0, 1) != "/" && text.substr(0, 1) != "!") return false;
        ...
        // Waffle: Default to spawn command
        return processCommand("/spawn " + text.substr(1), command, args);
		// return false;
	}
}
