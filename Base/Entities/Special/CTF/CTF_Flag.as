...
void onInit(CBlob@ this)
{
	...
	// Waffle: No fast return time so no indicators
...
void onTick(CBlob@ this)
{
	...
	if (!this.isAttached())
	{
        ...
        if (returncount < return_time)
		{
            ...
            returncount += this.getCurrentScript().tickFrequency;
		}
	}
...
void onRender(CSprite@ this)
{
    ...
    // Waffle: No fast return time so no indicator
