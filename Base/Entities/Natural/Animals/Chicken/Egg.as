...
void onTick(CBlob@ this)
{
	if (isServer() && getGameTime() > this.get_u32(CAN_GROW_TIME))
	{
		...
		// Waffle: Prevent chickens from spawning in blocks
		CMap@ map = getMap();
		if (map !is null && count < MAX_CHICKENS)
		{
			...
			server_CreateBlob("chicken", this.getTeamNum(), spawn_pos + chicken_height_offset);  // Waffle: Make chickens hatch to the correct team
		}
	}
}
