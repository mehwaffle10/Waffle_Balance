...
void onInit(CBlob@ this)
{
	...
	TreeVars vars;
	vars.r.Reset(seed);
	vars.growth_time = 350;  // 250 + vars.r.NextRanged(30);  // Waffle: Remove tree RNG and imbalance
	vars.height = 0;
	vars.max_height = 7;  // 3 + vars.r.NextRanged(3);  // Waffle: Remove tree RNG and imbalance
	vars.grown_times = 0;
