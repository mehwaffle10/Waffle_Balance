...
void onInit(CBlob@ this)
{
	...
	this.set_Vec2f("shop menu size", Vec2f(3, 2));  // Waffle: Seeds can be bought from quarters
	...
	{
		ShopItem@ s = addShopItem(this, "Chicken", "$quarters_chicken$", "chicken", Descriptions::chicken, false);  // Waffle: Chickens are bought directly from the store
		AddRequirement(s.requirements, "coin", "", "Coins", CTFCosts::chicken);
	}
	{
