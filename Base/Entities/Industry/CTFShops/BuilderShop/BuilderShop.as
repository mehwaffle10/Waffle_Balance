...
void onInit(CBlob@ this)
{
	...
	}
	{
		...
		s.buttonwidth = 2;
		s.buttonheight = 1;
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", 30);  // Hardcoded because config wasnt updating properly ie boulder only cost 30 but displayed 35. would find a better way to do this but its just balance testing
	}
	{
