...
void onTick(CBlob@ this)
{
	...
	for (uint i = 0; i < blobsInRadius.length; i++)
	{
		...
		if (blob !is this && vellen > blob.getShape().vellen && blob.hasTag("fake boat collision"))  // Waffle: Boats always collide // && blob.getTeamNum() != this.getTeamNum())
		{
