...
const u8 startStone = 200;  // Waffle: Start with full ammo
...
void onTick(CBlob@ this)
{
	...
	if (this.hasAttached() || this.get_bool("hadattached") || this.getTickSinceCreated() < 30 || this.get_bool("facing") != this.isFacingLeft() || time_til_fire > 0)  // Waffle: Fix catapult arm angle
	{
