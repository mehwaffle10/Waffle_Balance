...
{
	// this.Tag("bomberman_style");                 // Waffle: Kegs are circular
	// this.set_f32("map_bomberman_width", 24.0f);  // ^
	this.set_f32("explosive_radius", 48.0f);  // Waffle: Reduce explostion radius to compensate for circular kegs
	this.set_f32("explosive_damage", 10.0f);
	this.set_u8("custom_hitter", Hitters::keg);
	this.set_string("custom_explosion_sound", "Entities/Items/Explosives/KegExplosion.ogg");
	this.set_f32("map_damage_radius", 48.0f);  // Waffle: Reduce explostion radius to compensate for circular kegs
	this.set_f32("map_damage_ratio", 0.8f);
	this.set_bool("map_damage_raycast", false);  // Waffle: Kegs are circular
