...
void onTick(CBlob@ this)
{
	...
	//wrapped functionality
	{
        ...
        // Waffle: Allow spike drop at top of map
        CMap::Sector@[] sectors;
...
void onCollision(CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point)
{
    ...
    // Waffle: Hit vehicles and crates, dont ignore vehicle protection
	// only hit living things
    bool breakOnHit = blob.hasTag("vehicle") || blob.getName() == "crate";
	if (!blob.hasTag("flesh") && !breakOnHit || blob.hasTag("vehicle protection"))
	{
		return;
	}
	...
	if (state == falling)
	{
        ...
        // Waffle: Hit vehicles and crates
        if (breakOnHit)
        {
            this.server_Hit(this, point, Vec2f(0, -1), 3.0f, Hitters::fall, true);
        }
		return;
	}
