...
namespace CTFCosts
{
	...
	s32 buildershop_wood, quarters_wood, knightshop_wood, archershop_wood,
		...
		quarry_wood, quarry_stone, quarry_gold, quarry_count;
	...
	//Quarters.as
	s32 beer, meal, chicken, burger;  // egg
...
void InitCosts()
{
	...
	CTFCosts::tunnel_gold =                 ReadCost(cfg, "cost_tunnel_gold"        , 200);  // Waffle: Tunnel costs 100 coins
	...
	CTFCosts::quarry_gold =					ReadCost(cfg, "cost_quarry_gold"        , 80);   // Waffle: Quarries cost 80 coins
	...
	WARCosts::trampoline =         		ReadCost(cfg, "cost_trampoline"    		, 80);   // Waffle: Trampolines cost coins alongside the wood
	WARCosts::trampoline_wood =         ReadCost(cfg, "cost_trampoline_wood"    , 100);  // Waffle: Trampolines only cost wood from a single resupply
