...
void InitCosts()
{
	...
	CTFCosts::quarry_wood =                 ReadCost(cfg, "cost_quarry_wood"        , 100);  // Waffle: Quarries cost 250 wood
	CTFCosts::quarry_stone =				ReadCost(cfg, "cost_quarry_stone"       , 50);  // Waffle: Quarries cost 50 stone
